package com.inmersoft.trinidadpatrimonial.ui.trinidad.details.common
...
class DetailsTransformer(private val offscreenPageLimit: Int) : ViewPager2.PageTransformer {

    companion object {
        private const val TAG = "SliderTransformer"

        private const val DEFAULT_TRANSLATION_X = .9f
        ...
        private const val DEFAULT_ALPHA = 2f
